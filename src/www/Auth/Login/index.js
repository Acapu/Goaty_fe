...
export default class Login extends Component {
  ...
  loginUser = () => {
    ...
    api.loginUser(params).then((response) => {
      if (response['code'] === 'ok')
                    ...
                    <Row>
                      <Col md={6}>
                        <FormGroup>
                          ...
                          <Input type="email" name="email" id="exampleEmail" placeholder="Email here..." onChange={this.handleChange}/>
                        </FormGroup>
                      </Col>
                      <Col md={6}>
                        <FormGroup>
                          <Label for="examplePassword">Password</Label>
                          <Input type="password" name="password" id="examplePassword" placeholder="Password here..." onChange={this.handleChange}/>
                        </FormGroup>
                      </Col>
                    </Row>
                    <FormGroup check>
