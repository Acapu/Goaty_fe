...
import avatar1 from "../../../assets/utils/images/avatars/sakura wallpaper.png";
          ...
          <div className="widget-content p-0">
            <div className="widget-content-wrapper">
              ...
              <div className="widget-content-left  ms-3 header-user-info">
                <div className="widget-heading">Asyraf Mustaqim</div>
                <div className="widget-subheading">Studeng</div>
              </div>
